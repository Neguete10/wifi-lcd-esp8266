...
const char* ssid     = "Neguete-WIFI";
const char* password = "youpoor123";
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println("<title>Neguete 2.0</title>");
            ...
            // Web Page Heading
            client.println("<body><h1>Welcome to my swamp</h1>");
            
            // Display current state, and ON/OFF buttons for GPIO 5  
            client.println("<p>YELLOW LED IS " + output5State + "</p>");
